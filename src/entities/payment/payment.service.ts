...
export class PaymentService {
    ...
    private createDataObject(
        ...
        return {
            ...
            // phone: "string",
            success_url: `${process.env.PAYMENT_SUCCESS_URL}/${order?.tournament.id}/participate?isGoBack=true&centerText=Участие%20в%20турнире`,
            failure_url: `${process.env.PAYMENT_FAILURE_URL}/${order?.tournament.id}/participate?isGoBack=true&centerText=Участие%20в%20турнире`,
